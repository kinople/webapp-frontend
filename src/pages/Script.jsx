            ...
            <div style={styles.header}>
                ...
                >
                    {isUploading ? 'Uploading...' : 
                     isGeneratingBreakdown ? 'Generating Breakdown...' : 
                     'Import New Draft'}
                </button>
            </div>
                    ...
                    {isProcessing && (
                        <div style={styles.processingOverlay}>
                            ...
                            <p style={styles.processingText}>
                                {isUploading ? 'Uploading script...' : 'Generating breakdown...'}
                            </p>
                        </div>
                    )}
                    {!isProcessing && script_list.length === 0 && !uploadStatus && (
                        <p style={styles.placeholder}>Upload scripts to view them here</p>
                    )}
                    {!isProcessing && script_list.length > 0 && !pdfUrl && (
