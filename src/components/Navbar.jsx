          ...
          <div 
            ...
            onClick={() => {
              if (isInSettings) {
                ...
                const orgId = currentOrg === 'Personal' ? null : organizations.find(org => org.organizationname === currentOrg)?.organization_id;
                navigate(`/${user}`, { 
                  state: { 
                    organizationId: orgId,
                    organizationName: currentOrg 
          ...
          {isInSettings ? (
            ...
            >
              <div style={styles.workspaceLabel}>
                {userDetails?.email ? `${userDetails.email}'s Workspace` : 
                 user ? `${user}'s Workspace` : "User's Workspace"}
              </div>
            </div>
          ) : (
                  ...
                  <div>
                    ...
                    <div style={styles.userEmailDisplay}>
                      {loading ? 'Loading...' : 
                       ...
                       userDetails?.email || user || 'Email ID'}
                    </div>
                  </div>
                </div>
            ...
            <div style={styles.modalContent}>
              {loading ? (
                ...
                <div style={styles.userInfoModal}>
                  <p><strong>Username:</strong> {userDetails.email || user}</p>
                </div>
              ) : (
                <div style={styles.userInfoModal}>
              ...
              <div style={styles.modalActions}>
                <button 
                  style={loggingOut ? styles.buttonDisabled : styles.logoutButton}
