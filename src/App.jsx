...
function AppContent() {
  ...
  const isProjectPage = pathParts.length >= 2 && pathParts[1] && !['organizations', 'settings', 'create-project', 'create-organization'].includes(pathParts[1]);
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/:user/organizations/:organizationid" element={<ProtectedRoute><OrganizationDashboard /></ProtectedRoute>} />
        <Route path="/:user/settings" element={<ProtectedRoute><UserSettings /></ProtectedRoute>} />
        <Route path="/:user/create-project" element={<ProtectedRoute><CreateProject /></ProtectedRoute>} />
        <Route path="/:user/create-organization" element={<ProtectedRoute><CreateOrganization /></ProtectedRoute>} />
