...
function AppContent() {
	...
	const isProjectPage =
		pathParts.length >= 2 && pathParts[1] && !["organizations", "settings", "create-project", "create-organization"].includes(pathParts[1]);
		...
		<div>
			...
			<Routes>
				...
				<Route path="/:user/:id" element={<ProjectLayout />}>
					...
					/>
					<Route
						path="scheduling/:scheduleId/set-dates"
						element={
							<ProtectedRoute>
								<DOOD />
							</ProtectedRoute>
					...
					<Route
						...
						element={
							<ProtectedRoute>
								<ProjectSettingsDashboard></ProjectSettingsDashboard>
							</ProtectedRoute>
						}
					/>
				</Route>
